export const products = [
  ...
  },
  {
    ...
    applications: [
      "Confectionary, Snack Foods, Biscuits, Cereals, Ingredients, Dried Fruits + Nuts and Frozen Goods",
    ],
    model: [
      "EVFLD Drive Range: LD1, LD2, LD3, LD4",
      "Controller: R3FC, R3FSC, R5FC, R5FTS, CV6F, CV6FS, CV8F, CV8FS, CV10F",
  ...
  },
  {
    ...
    description: "1PC / 3PC BODY SCREW END",
    features: [
      "High Effeciency",
      "Low Maintenance",
      "Cost-Effecient",
